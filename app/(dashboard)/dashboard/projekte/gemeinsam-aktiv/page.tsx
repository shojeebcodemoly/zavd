...
export default function GemeinsamAktivDashboardPage() {
	...
	const form = useForm<FormValues>({
		...
		defaultValues: {
			hero: { backgroundImage: "", titleDe: "Gemeinsam Aktiv", titleEn: "Active Together", breadcrumb: "Gemeinsam Aktiv" },
	...
	useEffect(() => {
		const fetchContent = async () => {
			try {
				setLoading(true);
				const response = await fetch("/api/gemeinsam-aktiv-page");
				...
				form.reset({
					hero: {
						...
						titleDe: content.hero?.titleDe || "Gemeinsam Aktiv",
						titleEn: content.hero?.titleEn || "Active Together",
						breadcrumb: content.hero?.breadcrumb || "Gemeinsam Aktiv",
					},
					content: {
	...
	const onSubmit = async (values: FormValues) => {
		try {
			...
			toast.success("Gemeinsam Aktiv page saved successfully");
		} catch (error) {
	...
	return (
		<div className="space-y-6">
			<div className="flex items-start justify-between">
				<div>
					<h1 className="text-3xl font-medium tracking-tight">Gemeinsam Aktiv</h1>
					<p className="text-muted-foreground">Manage the Active Together page content.</p>
				</div>
				<a
						...
						<TabsContent value="hero" className="space-y-6">
							<Card>
								<CardHeader>
									...
									<CardDescription>The banner at the top of the Gemeinsam Aktiv page.</CardDescription>
								</CardHeader>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input {...field} value={field.value || ""} placeholder="Gemeinsam Aktiv" />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input {...field} value={field.value || ""} placeholder="Active Together" />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
						...
						<TabsContent value="content" className="space-y-6">
							<Card>
								<CardHeader>
									...
									<CardDescription>
										Main content on the left, with latest press and contact on the right.
									</CardDescription>
								</CardHeader>
								<CardContent className="space-y-6">
									<div className="grid gap-4 sm:grid-cols-2">
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem>
												...
												<FormDescription>Displayed on the right side of the content text.</FormDescription>
												<FormMessage />
											</FormItem>
										)}
									/>
														...
														<FormField
															...
															render={({ field }) => (
																<FormItem>
																	...
																	<FormControl>
																		<Input {...field} value={field.value || ""} placeholder="Abschnittsüberschrift..." />
																	</FormControl>
																	<FormMessage />
																</FormItem>
															)}
														...
														<FormField
															...
															render={({ field }) => (
																<FormItem>
																	<FormLabel>Body (DE)</FormLabel>
																	<FormControl>
																		<Textarea {...field} value={field.value || ""} placeholder="Absatzinhalt schreiben..." rows={5} />
																	</FormControl>
																	<FormMessage />
																</FormItem>
															)}
