...
export default function PatenschaftsprojektDashboardPage() {
	...
	useEffect(() => {
		const fetchContent = async () => {
			try {
				setLoading(true);
				const response = await fetch("/api/patenschaftsprojekt-page");
	...
	const onSubmit = async (values: FormValues) => {
		try {
			...
			toast.success("Patenschaftsprojekt page saved successfully");
		} catch (error) {
	...
	return (
		<div className="space-y-6">
			<div className="flex items-start justify-between">
				<div>
					<h1 className="text-3xl font-medium tracking-tight">Patenschaftsprojekt</h1>
					<p className="text-muted-foreground">Manage the Patenschaftsprojekt page content.</p>
				</div>
				<a
						...
						<TabsContent value="hero" className="space-y-6">
							<Card>
								<CardHeader>
									...
									<CardDescription>The banner at the top of the Patenschaftsprojekt page.</CardDescription>
								</CardHeader>
						...
						<TabsContent value="gallery" className="space-y-6">
							...
							<Card>
								<CardHeader>
									...
									<CardDescription>Image grid displayed below the hero.</CardDescription>
								</CardHeader>
								<CardContent className="space-y-4">
									<div className="grid gap-4 sm:grid-cols-2">
										<FormField
							...
							<Card>
								<CardHeader>
									...
									<CardDescription>
										Images appear in a 3-column grid on desktop. Recommended aspect ratio: 4:3.
									</CardDescription>
								</CardHeader>
								<CardContent className="space-y-4">
