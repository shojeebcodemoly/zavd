...
export default async function ZavdSpendenkontoPage({ params }: Props) {
	...
	const t = await getTranslations("zavdSpendenkonto");
	...
	try {
		...
		const res = await fetch(`${baseUrl}/api/zavd-spendenkonto-page`, { next: { tags: ["zavd-spendenkonto-page"] } });
	...
	const heroImage = hero.image || "/images/donate/Association1.jpg";
	...
	const iban = right.iban || "DE52 4785 0065 0000 8003 19";
