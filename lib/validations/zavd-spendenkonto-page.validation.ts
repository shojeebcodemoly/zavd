...
export const zavdSpendenkontoHeroSchema = z.object({
...
export const zavdSpendenkontoLeftSchema = z.object({
...
export const zavdSpendenkontoSpecialtyItemSchema = z.object({
	textDe: z.string().optional(),
	textEn: z.string().optional(),
});

export const zavdSpendenkontoMiddleSchema = z.object({
	...
	specialtyItems: z.array(zavdSpendenkontoSpecialtyItemSchema).optional(),
});

export const zavdSpendenkontoRightSchema = z.object({
...
export const updateZavdSpendenkontoPageSchema = z.object({
	hero: zavdSpendenkontoHeroSchema.optional(),
	left: zavdSpendenkontoLeftSchema.optional(),
	middle: zavdSpendenkontoMiddleSchema.optional(),
	right: zavdSpendenkontoRightSchema.optional(),
});

export type UpdateZavdSpendenkontoPageInput = z.infer<typeof updateZavdSpendenkontoPageSchema>;
